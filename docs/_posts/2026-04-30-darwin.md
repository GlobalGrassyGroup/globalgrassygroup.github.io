...
Large-scale international monitoring depends on strong local partnerships, regional expertise, and long-term datasets, supported by networks such as the Global Grassy Group, TERN, and our collaborators. These networks provide infrastructure, field experience, and the botanical and ecological knowledge needed to connect widely distributed experiments and datasets through common methods, placing local observations into a global context (Figure 4).
