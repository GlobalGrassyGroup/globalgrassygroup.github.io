...
On this website, you can find our suggested [sampling protocols](/resources/), a [workflow](/workflow/) for undertaking fieldwork and [managing data](/data-management/), and [publications](/datasets/) that used GGG. 

If you would like to contribute your data to the GGG Database or request datasets, please read our [Intellectual Property Guidelines](/intellectual-property/) and [contact us](/contact/).
